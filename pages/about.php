<div class="wrap yksme-page-about">
	...
	<div id="yksme-page-content">
		<div id="yksme-yikes-logo-container">	
				...
				<a href="http://www.yikesinc.com" title="YIKES, Inc." target="_blank" style="margin-bottom:1.5em;"><img src="<?php echo YKSEME_URL; ?>/images/yikes_logo.png" alt="YIKES, Inc." id="yksme-yikes-logo" /></a>
			...
			<div id="yks-mc-about-icon-container"  style="margin-top:2em;" >
