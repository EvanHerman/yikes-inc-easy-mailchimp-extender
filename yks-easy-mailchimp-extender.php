...
Plugin Name: Yikes' Easy Mailchimp Extender
...
if(!defined('YKSEME_PATH'))										define('YKSEME_PATH',									ABSPATH.'wp-content/plugins/yks-easy-mailchimp-extender/');
if(!defined('YKSEME_URL'))										define('YKSEME_URL',									plugins_url('yks-easy-mailchimp-extender/'));
