<div class="wrap about-wrap whats-new-wrap">
	...
	<div class="feature-section">
		...
		<p><?php _e( "In this latest release we've added an additional layer of customization. You now have a whole new set of options to tweak on the edit form page - allowing an additional depth of customization.'", 'yikes-inc-easy-mailchimp-extender' ); ?></p>
		<hr />
