	...
	<?php
		...
		$knowledge_base_links = array(
			array(
				...
				'href' => 'https://codeparrots.com/support/knowledge-base/how-do-i-change-the-submit-button-text/',
			),
			array(
				'title' => esc_attr__( 'How do I change the field labels?', 'yikes-inc-easy-mailchimp-extender' ),
				'href' => 'https://codeparrots.com/support/knowledge-base/how-do-i-change-the-field-labels/',
			),
			array(
				...
				'href' => 'https://codeparrots.com/support/knowledge-base/im-not-seeing-all-my-lists-on-the-drop-down-menu-when-i-go-to-make-a-new-form/',
			),
			array(
				'title' => esc_attr__( 'How do I add new fields to my opt-in form?', 'yikes-inc-easy-mailchimp-extender' ),
				'href' => 'https://codeparrots.com/support/knowledge-base/how-do-i-add-new-fields-to-my-form/',
			),
			array(
				'title' => esc_attr__( 'How do I place all of my form fields on one line?', 'yikes-inc-easy-mailchimp-extender' ),
				'href' => 'https://codeparrots.com/support/knowledge-base/how-do-i-place-all-of-my-form-fields-on-one-line/',
			),
		);
