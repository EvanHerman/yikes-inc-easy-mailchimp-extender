				...
				<div id="post-body-content">
					<div class="meta-box-sortables ui-sortable">
						<div class="postbox yikes-easy-mc-postbox">
							<h3 class="edit-form-title"><span><?php echo esc_html( $section_data['main_title'] ); ?></span></h3>
								<div class="inside <?php esc_attr_e( $section_data['id'] ); ?>-container">
									<?php 
										if( isset( $section_data['main_description'] ) && $section_data['main_description'] != '' ) {
											?>
												<p><?php echo  esc_html( $section_data['main_description'] ); ?></p>
											<?php
										}
										...
										foreach( $main_field_data as $field ) { 
											if( $field['type'] == 'custom' ) {
												...
												include( YIKES_MC_PATH . 'admin/partials/helpers/fields/yikes-mailchimp-' . esc_html( $field['type'] ) . '-field.php' );
											}
										}
									?>
								</div>
					...
					<?php if( self::is_custom_section_two_column( $section_data ) ) { ?>
						...
						<div id="postbox-container-1" class="postbox-container">
							<div class="meta-box-sortables">
								<div class="postbox yikes-easy-mc-postbox">
									<h3 class="edit-form-title"><span><?php echo esc_html( $section_data['sidebar_title'] ); ?></span></h3>
									<div class="inside <?php esc_attr_e( $section_data['id'] ); ?>-sidebar-container"> 
										<?php
											if( isset( $section_data['sidebar_description'] ) && $section_data['sidebar_description'] != '' ) {
												?>
													<p><?php echo esc_html( $section_data['sidebar_description'] ); ?></p>
												<?php
											}
