								...
								<table class="wp-list-table widefat fixed posts" cellspacing="0" id="yikes-easy-mc-manage-forms-table">
									...
									<tfoot>
										<tr>
											...
											<th class="manage-column column-columnname" scope="col"><?php _e( 'List Name' , $this->text_domain ); ?></th>
									...
									<tbody>
											...
											<tr class="<?php if( $i % 2 == 0 ) { echo 'alternate'; } ?>">
												...
												<td class="column-columnname"><?php echo stripslashes( $list['name'] ); ?>
													<div class="row-actions">
														...
														<span><a href="<?php echo add_query_arg( array( 'list-id' => $list['id'] ) , admin_url( 'admin.php?page=yikes-mailchimp-edit-list' ) ); ?>"><?php _e( "Merge Variables" , $this->text_domain ); ?></a> |</span>		
														<span><a href="<?php echo add_query_arg( array( 'list-id' => $list['id'] ) , admin_url( 'admin.php?page=yikes-mailchimp-edit-list' ) ); ?>"><?php _e( "Interest Groups" , $this->text_domain ); ?></a></span>
													</div>
												</td>
										...
										<?php 	
											...
											<tr class="no-items">
												<td class="colspanchange" colspan="3" style="padding:25px 0 25px 25px;"><em><?php _e( 'No MailChimp lists found. Head over to' , $this->text_domain ); ?> <a href="http://mailchimp.com/" target="_blank" title="MailChimp">MailChimp.com</a> <?php _e( "to setup your first mailing list. Once that's done you can head back here to customize it!" , $this->text_domain ); ?></em></td>
											</tr>
										<?php } ?>
									</tbody>
								</table> 
