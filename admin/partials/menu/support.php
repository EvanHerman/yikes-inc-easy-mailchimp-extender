...
<div class="wrap yikes-easy-mc-support-wrap yikes-easy-mc-wrap">
	...
	<?php if( get_option( 'yikes-easy-mc-active-addons' , array() ) == array() ) { ?>
		...
		<p><?php printf( __( 'Purchasers of our paid add-ons qualify for premium support. <a href="%s" target="_blank" title="' . __( 'Check out our paid add-ons', 'yikes-inc-easy-mailchimp-extender' ) . '">' . __( 'Check out our paid add-ons', 'yikes-inc-easy-mailchimp-extender' ) . '</a>!' , 'yikes-inc-easy-mailchimp-extender' ), esc_url( 'https://codeparrots.com/' ) ); ?></p>
	<?php } else { ?>
		...
		<p><?php _e( "If you have any problems with the form, send an email to <a href='mailto:support@codeparrots.com'>support@codeparrots.com</a> and a ticket will be created." , 'yikes-inc-easy-mailchimp-extender' ); ?></p>
	<?php } ?>

		<p><?php printf( __( 'Before submitting a support request, please visit our %s.' , 'yikes-inc-easy-mailchimp-extender' ), '<a target="_blank" href="' . esc_url( 'https://codeparrots.com/support/knowledge-base/product/easy-forms-for-mailchimp/' ) . '" title="' . __( 'Knowledge Base', 'yikes-inc-easy-mailchimp-extender' ) . '">' . __( 'knowledge base', 'yikes-inc-easy-mailchimp-extender' ) . '</a> where we have step-by-step guides and troubleshooting help' ); ?></p>
