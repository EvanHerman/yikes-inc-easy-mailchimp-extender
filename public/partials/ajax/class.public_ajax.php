	...
	*/
	public function sendUpdateProfileEmail() {
		...
		if ( ! isset( $email_body ) ) {
			...
			// $email_body .=	'<a href="' . $update_link_href . '" title="Update MailChimp Profile">';
			...
			// $email_body .= '<p>&nbsp;</p>';
			// $email_body .= '<p>' . sprintf( __( 'This email was sent from: %s', 'yikes-inc-easy-mailchimp-extender' ), $full_site_url ) . '</p>';
			// $email_body .= '<p>&nbsp;</p>';
			// $email_body .= '<p>&nbsp;</p>';
